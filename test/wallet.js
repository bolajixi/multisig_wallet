...
contract('Wallet', (accounts) => {
    ...
    it('should should have correct approver and quorum', async () => {
    ...
    it('should NOT create transfers if sender is not approved', async () => {
        await expectRevert(
            wallet.createTransfer(100, accounts[5], {from: accounts[4]}), 'Only approvers allowed'
        );
    });
    ...
    it('should NOT approve transfer if sender is not approved', async () => {
        await wallet.createTransfer(100, accounts[6], {from: accounts[0]});
        await expectRevert(
            wallet.approveTransfer(0, {from: accounts[4]}), 'Only approvers allowed'
            );
        });
